...
Написан калькулятор‑замыкание с различными операциями, которые меняются в самом коде, и начальным значением. При вызове calc() выполняется вычисление. Это значение возвращается и выводится на экран, а также сохраняется для следующих вызовов. При делении на ноль, программа выдает ошибку.
